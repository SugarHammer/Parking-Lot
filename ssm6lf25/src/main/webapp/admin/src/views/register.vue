  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">停车场微信小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			<!-- <div v-if="tableName=='chezhu'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='chezhu'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='chezhu'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='chezhu'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='chezhu'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='chezhu'">
			...
			<el-form-item label="车牌号" class="input" v-if="tableName=='chezhu'">
			  <el-input v-model="ruleForm.chepaihao" autocomplete="off" placeholder="车牌号"  />
			</el-form-item>
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.tingchechangmingcheng" class="input" type="text" placeholder="停车场名称">
			   </div>
			 </div> -->
			<el-form-item label="停车场名称" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.tingchechangmingcheng" autocomplete="off" placeholder="停车场名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">位置</div>
			   <div class="input-container">
			     <input v-model="ruleForm.weizhi" class="input" type="text" placeholder="位置">
			   </div>
			 </div> -->
			<el-form-item label="位置" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.weizhi" autocomplete="off" placeholder="位置"  />
			</el-form-item>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("https://ts1.tc.mm.bing.net/th/id/R-C.4459ae9714e14839db760690de3ae3a1?rik=eQjMVrHNk5NrpA&riu=http%3a%2f%2fwww.chinajiwu.cn%2fuploads%2fallimg%2f200709%2f1-200FZ93111.jpg&ehk=zoLhjv8T8yBcfqS7jZwg220DJD2ywhZuCJaBR9ymMNU%3d&risl=&pid=ImgRaw&r=0");
		height: 100vh;
